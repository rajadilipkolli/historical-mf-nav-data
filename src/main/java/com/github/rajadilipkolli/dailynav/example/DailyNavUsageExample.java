...
public class DailyNavUsageExample implements CommandLineRunner {
    ...
    public DailyNavUsageExample(MutualFundService mutualFundService, 
    ...
    public void run(String... args) throws Exception {
        ...
        if (healthStatus.isHealthy()) {
            ...
            System.out.printf("   📊 Data: %d schemes, %d NAV records, %d securities%n", 
        ...
        try {
            ...
            if (navOnDate != null) {
                System.out.printf("   NAV on or before %s: %.4f on %s%n", 
